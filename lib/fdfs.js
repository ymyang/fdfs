...
FdfsClient.prototype._uploadAppenderFile = function(file, options, callback) {
    var tracker = this._getTracker()
    ...
    tracker.getStoreStorage(options.group, function(err, storage) {
        ...
        storage.uploadAppenderFile(file, options, callback)
    })
}

FdfsClient.prototype._appendFile = function(file, options, callback) {
    var tracker = this._getTracker()
    ...
    tracker.getStoreStorage(options.group, function(err, storage) {
        ...
        storage.appendFile(file, options, callback)
    })
}

FdfsClient.prototype._modifyFile = function(file, options, callback) {
    var tracker = this._getTracker()
...
FdfsClient.prototype.uploadAppenderFile = function(file, options, callback) {
    var self = this
    if (is.function(options)) {
        callback = options
        options = {}
    ...
    _normalizeUploadParams(file, options, function(err) {
        ...
        self._uploadAppenderFile(file, options, callback)
    })
}

FdfsClient.prototype.appendFile = function(file, options, callback) {
    var self = this
    if (is.function(options)) {
        callback = options
        options = {}
    ...
    _normalizeUploadParams(file, options, function(err) {
        ...
        self._appendFile(file, options, callback)
    })
}

FdfsClient.prototype.modifyFile = function(file, options, callback) {
    var self = this
    if (is.function(options)) {
        callback = options
        options = {}
